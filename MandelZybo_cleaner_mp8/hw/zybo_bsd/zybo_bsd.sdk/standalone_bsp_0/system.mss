 ...
 PARAMETER NAME = D:\Xilinx\MandelZybo_cleaner_mp8\hw\zybo_bsd\zybo_bsd.sdk\standalone_bsp_0\system.mss
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = axi_mandelrisc
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = AXI_MandelRISC_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axi_mandelrisc
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = AXI_MandelRISC_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axi_mandelrisc
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = AXI_MandelRISC_2
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axi_mandelrisc
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = AXI_MandelRISC_3
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axi_mandelrisc
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = AXI_MandelRISC_4
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axi_mandelrisc
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = AXI_MandelRISC_5
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axi_mandelrisc
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = AXI_MandelRISC_6
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axi_mandelrisc
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = AXI_MandelRISC_7
END
